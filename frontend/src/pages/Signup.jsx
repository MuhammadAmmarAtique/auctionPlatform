...
const Signup = () => {
  ...
  const handleRegister = (e) => {
    ...
    // If the user selects the role of "Auctioneer", additional fields related to bank and payment details will be added
    role === "Auctioneer" &&
  ...
  const profileImgPreviewHandler = (e) => {
    ...
    reader.readAsDataURL(file); //it will read file & convert it into data url making it easier to preview or display in HTML.
    reader.onload = () => { //When the file has been fully loaded (after being converted to a data URL), this function will run.
      setProfileImg(file); //storing actual file
      setProfileImgPreview(reader.result); //storing data url for preview in frontend
    };
  };
        ...
        >
          ...
          <div className="flex flex-col sm:flex-1 gap-2">
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <input type="file" onChange={profileImgPreviewHandler} />
            </div>
          </div>
